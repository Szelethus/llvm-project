...
eventsDescribeSameCondition(PathDiagnosticEventPiece *X,
  ...
  // those that came from TrackConstraintToNullptrVisitor,
  ...
  const void *tagLesser = TrackConstraintToNullptrVisitor::getTag();
...
/// generated by both ConditionBRVisitor and TrackConstraintToNullptrVisitor.
/// Both BugReporterVisitors use different methods to generate diagnostics, with
